...
const Header = ({setUserSession}) => {
  ...
  const login = (e)=>{
    ...
    if(fields.email==='user1@test.com' && fields.password==='user@123'){
      toggleModal('close')
      setUserDetails({email: fields.email,name: 'User 1'})
      setUserSession({email: fields.email,name: 'User 1'})
    }else{
          ...
          <div className="flex w-full items-center justify-between px-4">
            ...
            <div className="hidden justify-end pr-16 sm:flex lg:pr-0">
              ...
              <React.Fragment>
                      ...
                      <a href="#" onClick={(e)=>logout(e)} className="no-underline px-4 py-2 block text-black hover:bg-gray-300">Logout</a>
                    </React.Fragment>
              :
