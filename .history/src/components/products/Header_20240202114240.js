...
const Header = ({setUserSession}) => {
  ...
  const login = (e)=>{
    ...
    if(fields.email==='user1@test.com' && fields.password==='user@123'){
      let userDetails = JSON.stringify({email: 'user1@test.com',name: 'User 1'})
      window.sessionStorage.setItem("userDetails", userDetails);
      toggleModal('close')
      setUserDetails({email: 'user1@test.com',name: 'User 1'})
      setUserSession({email: 'user1@test.com',name: 'User 1'})
    }else{
        ...
        <div className="relative -mx-4 flex items-center justify-between">
          ...
          <div className="flex w-full items-center justify-between px-4">
            ...
            <div className="hidden justify-end pr-16 sm:flex lg:pr-0">
              ...
              <React.Fragment>
                      <label htmlFor="remember" className="px-4 py-2 text-sm font-medium text-gray-900 dark:text-gray-300">Welcome : <b>{userDetails.name}</b></label>
                      <a href="#" onClick={(e)=>logout(e)} class="no-underline px-4 py-2 block text-black hover:bg-gray-300">Logout</a>
                    </React.Fragment>
              :
                          ...
                          <div className="p-4 md:p-5">
                              <form className="space-y-4" onSubmit={(e)=>login(e)}>
                                  ...
                                  <div>
                                      ...
                                      <input type="password" name="password" value={fields.password} id="password" onChange={(e)=>handleChange(e)} placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required />
                                  </div>
